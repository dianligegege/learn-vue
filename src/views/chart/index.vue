...
export default {
    mounted() {
        // 表格1
        const dom = document.getElementsByClassName('chart1')[0];
        const chart = createChart(dom, { width: 600, height: 300 });
        ...
        // 表格2
        const dom2 = document.getElementsByClassName('chart2')[0];
        const chart1 = createChart(dom2, {
            width: 600,
            height: 300,
            layout: {
